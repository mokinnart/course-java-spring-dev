package ru.mokinnart.skillbox.mod4.aspect;
...
import ru.mokinnart.skillbox.mod4.repository.CommentRepository;
import ru.mokinnart.skillbox.mod4.repository.NewsRepository;
...
public class NewsOwnershipAspect {
    ...
    @Before("@annotation(ru.mokinnart.skillbox.mod4.CheckNewsOwnership)")
    ...
    @Before("@annotation(ru.mokinnart.skillbox.mod4.CheckCommentOwnership)")
